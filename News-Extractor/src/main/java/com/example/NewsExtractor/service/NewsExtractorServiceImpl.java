...
import com.example.NewsExtractor.util.NewsExtractorHelper;
...
public class NewsExtractorServiceImpl implements NewsExtractorService {
    ...
    public NewsExtractorServiceImpl() {
    }
    ...
    public void loadContents() throws IOException {
        ...
        NewsExtractorHelper scraperHelper = new NewsExtractorHelper(newspaperUrl, parseTimeoutMillis, articleDetailsSearchTags, articleLinksSearchTags);
