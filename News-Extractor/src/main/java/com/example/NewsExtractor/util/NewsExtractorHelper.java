package com.example.NewsExtractor.util;
...
public class NewsExtractorHelper {
    ...
    public NewsExtractorHelper(String pageUrl, Integer pageParseTimeoutMillis, List<String> detailsSearchTag,
